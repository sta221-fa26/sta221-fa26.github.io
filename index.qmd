...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1Bdo9hpGjiUlN4ZE0ySMpRedLvEzg03159aEf-z1q65Q/edit?usp=sharing", sheet = "Sheet1")
```
...
d |>
  select(-c(`Maria's notes`, `Spring 2026 Topic`)) |>
  mutate(
    date = as.Date(date),
