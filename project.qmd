...
- [**Part 0: Team agreement + Collaboration in GitHub**] due Tuesday, September 29

- [**Part 1: Project proposal**]**:** due Tuesday, September 29

- **Part 2: Exploratory data analysis:** due Thursday, October 29

- **Part 3: Presentation + Presentation comments:** Monday, November 23 in lab

- **Part 4: Draft report + Peer review:** Monday, November 30 in lab

- **Part 5: Final write up + Project repo:** due Friday, December 4
...
## Part 0: **Team agreement + Collaboration in GitHub** 

\[Add the previous instructions\]
...
Write the narrative and analysis (Sections 1- 4) for each data set in `proposal.qmd`. Put the data set and the data dictionary in the \`data\` folder in the repo. Push the \`qmd\` and rendered \`pdf\` documents to GitHub by the deadline, \*\*Tuesday, February 24 at 11:59pm.\*\*
:::
...
Include the following for each data set:
...
- Distribution of rsponse variable

- List of potential predictors

### Section 4: Data dictionary 

- You may use the data dictonary from the data source, with citations.
