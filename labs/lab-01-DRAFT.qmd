...
For each of the following, indicate whether the statement is true or false. If true, state which property of matrix addition/ multiplication is being applied. If false, explain why.
...
State whether each of the following is nonsingular (i.e., invertible). Explain your response. If you do not have enough information to answer, state what other information you need to definitively answer.
