...
- The TAs let me know that a lot of groups did not finish the lab; we will take this into account when grading this lab.

  - I will also take this into account for future labs
...
$$\text{audience\_score} = 32.314 + 0.519 \times \text{critics\_score}$$
...
::: appex
📋 [sta221-sp26.github.io/ae/ae-01-model-evaluation.html](../ae/ae-01-model-evaluation.html)
