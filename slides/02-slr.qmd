...
## Movie scores \[UPDATE - ADD ARTICLE TO CANVAS\]

::::: columns
::: {.column width="70%"}
- Data behind the FiveThirtyEight (now defunct) story [*Be Suspicious Of Online Movie Ratings, Especially Fandango's*](https://fivethirtyeight.com/features/fandango-movies-ratings/)\[UPDATE LINK\]
...
## Why fit a line? \[MAKE WOOCLAP POLL FOR INFERENCE\]
...
## Interpretation \[UPDATE to WOOCLAP\]
...
```{=html}
<iframe allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 500px; min-height: 355px" src="https://edstem.org/us/courses/90766/discussion/7506084" width="100%"></iframe>
```
:::::

🔗 <https://edstem.org/us/courses/90766/discussion/7506084>
...
- Accept GitHub invite (check your email or see the invite at <https://github.com/sta221-fa26>)
  - Need to be in course organization to access lab
- Office hours start Monday (see schedule on Canvas home page)
- Lab 01 on Monday
