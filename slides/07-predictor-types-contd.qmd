...
$$
\hat{\beta}_\text{age} = 268.050 \hspace{10mm} \hat{\beta}_\text{age-sq} = -5.916
$$
...
- Expected change in weight:
  ...
  - 20 to 24 months: `r round(268.050 * (24 - 20) + -5.916 * (24^2 - 20^2), 3)` (`round(268.050 * (24 - 20) + -5.916 * (24^2 - 20^2)`)
