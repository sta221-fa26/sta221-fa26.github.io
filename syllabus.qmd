...
For students who take all three exams <!--# need to update this to say in-class exams, so a student can't just take the take-home to count-->, the final exam score will replace the lower of the two mid-term scores, if the final exam score is higher than the Exam 01 and/or Exam 02 score.
...
- **UPDATE THIS use of artificial intelligence (AI)**: You should treat AI tools, such as ChatGPT, the same as other online resources. There are two guiding principles that govern how you can use AI in this course:[^2] (1) *Cognitive dimension:* Working with AI should not reduce your ability to think clearly. We will practice using AI to facilitate---rather than hinder---learning. (2) *Ethical dimension***:** Students using AI should be transparent about their use and make sure it aligns with academic integrity.
...
🔗 <https://forms.cloud.microsoft/r/ksZvHWmz0f> **UPDATE THIS**
